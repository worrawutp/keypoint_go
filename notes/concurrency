...
### ใช้ WaitGroup และ for/select เมื่อมี goroutine หลายชุด
...
6. สร้าง goroutine สำหรับ WaitGroup goroutine ตัวนี้จะเป็นกลไกที่คอยตรวจสอบ WaitGroup counter ว่ามีงานเหลืออยู่หรือไม่ ถ้าไม่มีงานเหลือแล้ว ก็จะ trigger `doneChannel`
7. สร้าง for/select เพื่อจัดการกับข้อมูลที่อยู่ใน channel เช่น 
  ...
  - กำหนดว่าจะทำอะไร ในกรณีที่ doneChannel ทำงาน
